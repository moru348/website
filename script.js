...
'<span style="color: hsl(32, 88%, 51%)">Iam</span>(\'<span class="name" id="name" style="color: hsl(0, 0%, 92%);">moru<span class="namethree" style="padding-left: 0px">3</span></span>\')</span>',
];
...
if( ref.length != 0 ) {
    if( ref.match( rExp ) ) {
        titles = ['<span style="color: hsl(32, 88%, 51%)">Iam</span>(\'<span class="name" id="name" style="color: hsl(0, 0%, 92%);">moru<span style="color: hsl(288, 100%, 60%);">3</span></span>\')</span>']
    }
}
